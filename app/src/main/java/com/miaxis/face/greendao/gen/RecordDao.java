...
public class RecordDao extends AbstractDao<Record, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Finger0 = new Property(10, byte[].class, "finger0", false, "FINGER0");
        public final static Property Finger1 = new Property(11, byte[].class, "finger1", false, "FINGER1");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RECORD\" (" + //
                ...
                "\"FINGER0\" BLOB," + // 10: finger0
                "\"FINGER1\" BLOB," + // 11: finger1
    ...
    protected final void bindValues(DatabaseStatement stmt, Record entity) {
        ...
        if (finger0 != null) {
            stmt.bindBlob(11, finger0);
        }
 
        byte[] finger1 = entity.getFinger1();
        if (finger1 != null) {
            stmt.bindBlob(12, finger1);
        }
    ...
    public Record readEntity(Cursor cursor, int offset) {
        Record entity = new Record( //
            ...
            cursor.isNull(offset + 10) ? null : cursor.getBlob(offset + 10), // finger0
            cursor.isNull(offset + 11) ? null : cursor.getBlob(offset + 11), // finger1
    ...
    public void readEntity(Cursor cursor, Record entity, int offset) {
        ...
        entity.setFinger0(cursor.isNull(offset + 10) ? null : cursor.getBlob(offset + 10));
        entity.setFinger1(cursor.isNull(offset + 11) ? null : cursor.getBlob(offset + 11));
