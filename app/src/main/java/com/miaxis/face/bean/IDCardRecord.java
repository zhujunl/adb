...
//    public IDCardRecord(Long id, String cardType, String cardId, String name, String birthday,
//            String address, String cardNumber, String issuingAuthority, String validateStart,
//            String validateEnd, String sex, String nation, String fingerprint0,
//            String fingerprintPosition0, String fingerprint1, String fingerprintPosition1,
//            String passNumber, String issueCount, String chineseName, String version,
//            String cardPhotoPath, String facePhotoPath, int verifyMode, boolean faceResult,
//            boolean fingerResult, float faceScore, float fingerScore, boolean verifyResult,
//            Date verifyTime, String orgName, String describe, String location, boolean upload) {
//        this.id = id;
